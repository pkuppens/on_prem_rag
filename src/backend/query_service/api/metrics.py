"""Metrics API endpoint for the Query Service.
...
logger = StructuredLogger(__name__) if False else None

# Avoid circular import for logger
...
def _get_index_chunk_count() -> int:
    ...
    try:
        ...
        vs = get_vector_store_read(config)
        return vs.get_chunk_count()
