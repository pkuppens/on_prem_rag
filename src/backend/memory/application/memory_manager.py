"""Memory Manager — Application Service for the Memory BC.

Provides a unified interface for all memory operations across the three
...
Usage:
    from backend.memory.application.memory_manager import MemoryManager, get_memory_manager
