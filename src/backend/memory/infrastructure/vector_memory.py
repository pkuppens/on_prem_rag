...
Implements the IVectorMemory port interface.
...
from backend.memory.domain.interfaces import IVectorMemory
...
class VectorMemory(IVectorMemory):
    ...
    Implements the IVectorMemory port.
    """
