"""Short-term session memory store infrastructure.
...
Implements the ISessionStore port interface.
...
from backend.memory.domain.interfaces import ISessionStore
...
class SessionStore(ISessionStore):
    ...
    Implements the ISessionStore port.
    """
